...
const Program = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Bevezető és koncertprogram</title>
        <meta name="description" content="A koncertek bevezetöje és a koncertprogram" />
        <link rel="canonical" href="https://hammerschmidt-consort.com/koncertprogram" />
      </Helmet>
