  ...
  <div>
    ...
    <div className="relative mx-auto px-4 h-[88vh]">
      <div className="absolute text-center text-white top-[50%] translate-y-[-50%]">
        ...
        <p className="text-lg font-content-thin tracking-[1px] sm:text-base md:text-xl mt-5 max-w-[90%] md:max-w-[70%] drop-shadow-lg mx-auto high-contrast-text text-justify md:text-center">
