const Banner = () => {
  ...
  <div>
    ...
    <div className="relative mx-auto px-4 h-[88vh]">
      <div className="absolute text-center text-white top-[50%] translate-y-[-50%]">
        ...
        <div className="mt-3">
          <a href="#concerts" className="inline-block mt-5 px-7 py-2 rounded-full bg-[#A14028] shadow-lg text-white font-bold hover:bg-[#A14028] transition duration-200 high-contrast-obj scroll-trigger" data-scroll-target="concerts">
            Helyszínek
          </a>
          <a href="#musicians" className="inline-block mt-5 ml-5 px-7 py-2 rounded-full border-2 border-[#A14028] shadow-lg text-[#A14028] font-bold bg-[#E4BF87] transition ease-in-out duration-300 high-contrast-obj scroll-trigger" data-scroll-target="musicians">
            Művészek
          </a>
        </div>
      </div>
